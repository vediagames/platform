...
FROM games
         ...
         LEFT JOIN json_tags_view jtv on gt.tag_id = jtv.id AND jtv.language_code = al.code
         LEFT JOIN json_categories_view jcv on gc.category_id = jcv.id AND jcv.language_code = al.code
